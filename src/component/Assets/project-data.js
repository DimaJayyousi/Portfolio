...
import dema from '../Assets/dema.png'
...
const projects = [
  ...
  { type: '3D projects', caption: 'What’s inside? Only the render knows!', image: container },
  { type: '3D projects', caption: 'Sweet, smooth, and digitally delicious!🍫', image: chocolate , url:"https://drive.google.com/file/d/137mTYEdff_g1pI8GDBcMr_ngYX4qbRk8/view?usp=sharing"},
  { type: '3D projects', caption: 'A fragrance so real, you can almost smell it', image:dema  },
  { type: '3D projects', caption: 'Even the packaging deserves a spotlight!', image: green },
  {type: '3D projects',caption: 'Matte, glossy, and digitally flawless 💄', image: lipstick,  url:"https://drive.google.com/file/d/1PjpvjAfuF3P7Cskor8jzthUXLyPtiv8d/view?usp=sharing" },
  ...
  { type: 'Documentation', caption: 'Training Smarter Models: Exploring ImageNet Dataset ', image: ai ,url:"https://drive.google.com/file/d/1lIF2P-6ZMGEb-C6_U9hjnvP2qpcYTv7i/view?usp=sharing"},
  { type: 'Documentation', caption: 'Smart Scheduling, Better Healthcare – Our Medical Appointment System', image: sw , url:"https://drive.google.com/file/d/1LPjM4B0Cjzoj8qXgGGKlIspxAaEFc6jN/view?usp=sharing" },
];
